...
## Introduction
This repo contains analysis of product visibility data given by @getnervs.
I am **Dotun Olatunde** and here's a quick walkthrough of my workflow and key findings.
...
## Requirements
Please install the latest version of **Python** from **python.org** as this was the primary programming language used throughout this project.
After installing **Python,** the following dependencies should be installed: 
**pandas,** **numpy,** **streamlit,** **matplotlib,** and **plotly.**
Use **pip install (name of dependency, e.g. pandas)** to install the dependencies.
...
- Checking for outliers by standardizing long/lat columns.
...
You can check the **plot** directory to view the static dashboards.
Feel free to also explore the interactive dashboard (via the Streamlit app in this repository) for a deeper dive into the data and to experiment with different filters.
You can access the visualizations online at: https://my-visualizations.streamlit.app

**Got questions or feedback ?**
[Click here to chat with me on WhatsApp](https://wa.me/+2348027834543)
Or email me at: olatundedotun6@gmail.com
